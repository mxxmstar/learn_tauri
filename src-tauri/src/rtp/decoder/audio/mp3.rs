...
impl Mp3Decoder {
    ...
    pub fn new() -> Result<Self, String> {
        // 创建 FFI 解码器
        // MP3 codec_type = 8, 输出格式 S16 (packed)
        let ffi_decoder = FfiDecoder::new_audio(8, SampleFormat::S16.to_u32() as i32)?;
